...
func NewFuranBuilderBackend(addrs []string, caddr string, dl persistence.DataLayer, mc metrics.Collector, logout io.Writer, datadogServiceName string) (*FuranBuilderBackend, error) {
	...
	fc, err := furan.NewFuranClient(fcopts, logger, datadogServiceName)
	if err != nil {
