...
// PVCSecretsFetcher uses a github.com/dollarshaveclub/pvc client to communicate and pull secrets from Vault
type PVCSecretsFetcher struct {
	sc *pvc.SecretsClient
}

// NewPVCSecretsFetcher will return a PVCSecretsFetcher with the provide Secrets Client
...
//// Below added to support different fetcher types and consolidate creating the correct fetcher to the secrets package
